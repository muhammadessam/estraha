            ...
            <div class="col-sm-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <a href="{{route('places.create')}}"  type="button" class="btn btn-default btn-circle"  title="{{Lang::get('esteraha.add')}}" style="background:none; color:dodgerblue; border: none; float: left; color: white" ><i class="fa fa-plus fa-lg" style="font-size: 21px;"></i></a>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>{{Lang::get('esteraha.address')}}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="{{route('places.edit',$place->id)}}" data-toggle="tooltip"  data-original-title="{{Lang::get('esteraha.edit')}}"><i class="ti-pencil text-inverse m-r-10"></i></a>

                                    <a  id="delete" href="{{URL::to('ownerplaces/destroy/' .$place->id)}}" data-toggle="tooltip"  data-original-title="{{Lang::get('esteraha.delete')}}"><i class="ti-close text-danger"></i></a>
