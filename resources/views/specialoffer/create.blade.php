    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-md-6 col-sm-1 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active" >{{Lang::get('esteraha.addspecialoffer')}}</li>
            </ol>
        </div>
...
@section('content')
    ...
    {!! Form::open(array('url' => url('places'), 'class'=>'form-horizontal' , 'files'=>true )) !!}
    @include ('errors.list')


    @include ('specialoffer.form' , ['submit' => 'Add'])
